          ...
          >
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Account based signups each with their own administrators and
                    users
                  </h3>
                </div>
              }
          ...
          >
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Dashboard is the first thing user sees when logged in and
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Users would be able to manage and publish their profiles to
                    other users
                  </h3>
                </div>
              }
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Users might receive regular automated emails from the app to
                    drive engagement
                  </h3>
                </div>
              }
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Typical use case would be restaurant reviews or customer
          ...
          >
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Allowing users to send messages to other account users
                  </h3>
                </div>
              }
            >
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Classic forum functionality or simple commenting function
                  </h3>
                </div>
              }
            >
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Ability to share pieces of information in a controlled way
          ...
          >
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Your app will have revenue model where customers will pay
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Users will be able to browse products and add them to the
                    cart
                  </h3>
                </div>
              }
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Ability to manage date, e.g. product listings,
                    availabilities of products or other data
                  </h3>
                </div>
              }
            >
          ...
          >
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Content management system would allow edititing of
                    significant parts of the static content without developer
                    intervention
                  </h3>
                </div>
              }
            ...
            <Tooltip
              title={
                <div className={styles.tooltip}>
                  <h3>
                    Find out where users come from and how they use your app
                  </h3>
                </div>
              }
            >
